...
@section('content')
	...
	<div class="container" style="width: 1100px; overflow-x: hidden;">
		...
		{!! Form::open(['url'=>route('admin.getUpcomingBetween'), 'class'=>'form-horizontal', 'method'=>'POST', 'enctype'=>'multipart/form-data']) !!}
		@csrf
		<div class="form-row">
			<div class="col">
				С
		...
		{!! Form::open(['url'=>route('admin.getUpcomingTake'), 'class'=>'form-horizontal', 'method'=>'POST', 'enctype'=>'multipart/form-data']) !!}
		@csrf
		<div class="form-row">
		...
		<div class="form-group">
			<div class="col-xs-offset-2 col-xs-10">
				{!! Form::button('Вывести на главный экран', ['class'=>'btn btn-primary', 'type'=>'submit']) !!}
			</div>
		</div>
