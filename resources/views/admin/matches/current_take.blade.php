...
@section('content')
	...
	<div class="container" style="width: 1100px; overflow-x: hidden;">
		...
		<div id="admin-matches" >
			...
			<div>
				<p>Текущие матчи: Количество записей</p>
		...
		{!! Form::open(['url'=>route('admin.getCurrentBetween'), 'class'=>'form-horizontal', 'method'=>'POST', 'enctype'=>'multipart/form-data']) !!}
		@csrf
		<div class="form-row">
			<div class="col">
				С
		...
		{!! Form::open(['url'=>route('admin.getCurrentTake'), 'class'=>'form-horizontal', 'method'=>'POST', 'enctype'=>'multipart/form-data']) !!}
		@csrf
		<div class="form-row">
