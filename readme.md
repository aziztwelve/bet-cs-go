Installation
    ...
    Run 'npm install' to install the dependencies as defined in the package.json file.
    you can create .env by cp .env.example .env then add your db credential in it.
    Run 'php artisan key:generate' to generate a key for your app.
    Run 'php artisan migrate' to run the database migrations.
    
    Run 'php artisan serve' to Serve the application on the PHP development server.
